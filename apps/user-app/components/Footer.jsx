      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center md:items-start">
            ...
            <h2 className="text-2xl font-bold mb-2">Ezpay Industries Ltd.</h2>
            <p className="text-sm text-indigo-200">
              Providing reliable Fintech since 1992
            </p>
          </div>
          <div className="flex flex-col items-center md:items-start">
        ...
        <div className="mt-8 pt-8 border-t border-indigo-500 text-center">
          <p className="text-sm text-indigo-200">
            &copy; {currentYear} Ezpay Industries Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
